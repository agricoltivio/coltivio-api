CREATE TABLE IF NOT EXISTS "federal_farm_plots" (
...
CREATE INDEX IF NOT EXISTS "federal_farm_plots_geometries_idx" ON "federal_farm_plots" USING gist ("geometry");--> statement-breakpoint
