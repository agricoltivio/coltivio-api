...
export const getPlotsLayerForBoundingBoxEndpoint = authenticatedEndpointFactory.build({
  method: "get",
...
export const getPlotsForFederalFarmIdEndpoint = authenticatedEndpointFactory.build({
  method: "get",
